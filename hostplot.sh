...
plot '/var/log/hoststat.dat' using 1:2 t 'Cpu usage %' with lines lw 2, \
     '/var/log/hoststat.dat' using 1:3 t 'Load Average' with lines, \
     '/var/log/hoststat.dat' using 1:4 t 'Memory usage %' with lines, \
     '/var/log/hoststat.dat' using 1:5 t 'Swap usage %' with lines lw 2, \
     '/var/log/hoststat.dat' using 1:6 t 'Disk space usage %' with lines lw 2, \
     ...
     '/var/log/hoststat.dat' using 1:10 t 'PHP mail queue x 10' with lines lw 2
