...
plot '/var/log/hoststatproc.dat' using 1:4 t 'Apache Procs Num' with filledcurves y1=0 lc rgb "#ffcc00", \
     ...
     '/var/log/hoststatproc.dat' using 1:5 t 'MySQL CPU Usage %' with lines lt 8 lw 1 lc rgb "#0000cc", \
     '/var/log/hoststatproc.dat' using 1:6 t 'MySQL Memory Usage %' with lines lt 1 lw 2 lc rgb "#0000cc"
